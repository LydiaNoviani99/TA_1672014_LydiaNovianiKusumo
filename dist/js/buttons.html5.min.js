(function(i){"function" === typeof define && define.amd?define(["jquery", "datatables.net", "datatables.net-buttons"], function(g){return i(g, window, document)}):"object" === typeof exports?module.exports = function(g, k, q, r){g || (g = window); if (!k || !k.fn.dataTable)k = require("datatables.net")(g, k).$; k.fn.dataTable.Buttons || require("datatables.net-buttons")(g, k); return i(k, g, g.document, q, r)}:i(jQuery, window, document)})(function(i, g, k, q, r, p){function y(a, c){s === p && (s = - 1 === v.serializeToString(i.parseXML(z["xl/worksheets/sheet1.xml"])).indexOf("xmlns:r"));
        ...
        l.ext.buttons.excelHtml5 = {className:"buttons-excel buttons-html5", available:function(){return g.FileReader !== p && (q || g.JSZip) !== p && !G() && v}, text:function(a){return a.i18n("buttons.excel",
                ...
                d = n(f, "cols"); i("worksheet", f).prepend(d); j = 0; for (l = c.header.length; j < l; j++)d.appendChild(n(f, "col", {attr:{min:j + 1, max:j + 1, width:I(c, j), customWidth:1}})); b.customize && b.customize(a); c = new (q || g.JSZip); d = {type:"blob", mimeType:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}; y(c, a); c.generateAsync?c.generateAsync(d).then(function(a){o(a, u(b))}):o(c.generate(d), u(b))}, filename:"*", extension:".xlsx", exportOptions:{}, header:!0, footer:!1};
