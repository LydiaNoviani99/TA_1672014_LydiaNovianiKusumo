...
<div style="overflow-x:auto;">
    <table class="table table-striped" id="tblGrid">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td></td>
                <td class="text-right">
                    <input id="nilaiA1Sidang2" style="min-width:30px" type="number" min="0" max="100" class="form-control calculateSidang2" required=""/>
                </td>
    ...
    <div class="col-sm-12" style="text-align: left;">
        <button style="width: 100%" type="button" data-toggle="modal" id="btnSaveNilaiSidang2" value="Simpan" class="btn btn-info">Simpan Nilai</button>
    </div>
</div>